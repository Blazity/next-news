...
export type GetRecentArticlesQueryWithMainQuery = { mainArticle: Array<{ id: string, publishedAt?: any | null, updatedAt: any, locale: Locale, slug: string, title: string, author?: { name: string, avatar?: { data: { url: string } } | null } | null, tags: Array<{ tag: string }>, content?: { raw: any } | null, image?: { description?: { text: string } | null, data: { url: string } } | null }>, articles: Array<{ id: string, publishedAt?: any | null, updatedAt: any, locale: Locale, slug: string, title: string, author?: { name: string, avatar?: { data: { url: string } } | null } | null, tags: Array<{ tag: string }>, image?: { description?: { text: string } | null, data: { url: string } } | null }>, articlesConnection: { aggregate: { count: number } } };
...
export type GetArticleRecommendedArticlesQuery = { article?: { recommendedArticles: Array<{ title: string, slug: string, id: string, publishedAt?: any | null, tags: Array<{ tag: string }>, author?: { name: string, avatar?: { data: { url: string } } | null } | null, image?: { description?: { text: string } | null, data: { url: string } } | null }> } | null };
...
export type GetArticleBySlugQuery = { articles: Array<{ id: string, title: string, publishedAt?: any | null, tags: Array<{ tag: string }>, image?: { id: string, description?: { text: string } | null, data: { url: string } } | null, author?: { id: string, name: string, avatar?: { data: { url: string } } | null } | null, content?: { raw: any, references: Array<{ id: string }> } | null, categories: Array<{ title: string, slug: string }> }> };
...
export type GetArticleMetadataBySlugQueryQuery = { articles: Array<{ seoComponent?: { title?: string | null, description?: { text: string } | null } | null, image?: { title: string, data: { url: string }, description?: { text: string } | null } | null, author?: { name: string } | null }> };
...
export type ListArticlesBySlugQuery = { articles: Array<{ id: string, title: string, slug: string, publishedAt?: any | null, image?: { id: string, description?: { text: string } | null, data: { url: string } } | null, author?: { id: string, name: string, avatar?: { data: { url: string } } | null } | null, tags: Array<{ tag: string }> }> };
...
export type ListArticlesByCategoryQuery = { articles: Array<{ publishedAt?: any | null, slug: string, title: string, id: string, image?: { description?: { text: string } | null, data: { url: string } } | null, author?: { name: string, avatar?: { data: { url: string } } | null } | null, tags: Array<{ tag: string }> }>, articlesConnection: { aggregate: { count: number } } };
